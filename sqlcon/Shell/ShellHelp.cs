...
namespace sqlcon
{
    partial class Shell
    {
        ...
        private static void Help()
        {
            ...
            cout.WriteLine("run [drive:][path]file  : run a batch program (.sqc)");
            cout.WriteLine("call [drive:][path]file : call Tie program (.sqt)");
