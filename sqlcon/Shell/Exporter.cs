    ...
    class Exporter
    {
        ...
        public void ExportClass()
        {
            DpoOption option = new DpoOption
            {
                ...
                OutputPath = cmd.OutputPath(ConfigKey._GENERATOR_DPO_PATH, $"{ConfigurationFile.MyDocuments}\\DataModel\\Dpo"),
        ...
        {
            string path = this.cmd.OutputPath(ConfigKey._GENERATOR_CSV_PATH, $"{ConfigurationFile.MyDocuments}\\csv");
        ...
        private void ExportDataContractClass(int version, TableNameData tnd)
        {
            ...
            if (gen != null)
            {
                string path = cmd.OutputPath(ConfigKey._GENERATOR_DC_PATH, $"{ConfigurationFile.MyDocuments}\\dc");
        ...
        {
            string path = cmd.OutputPath(ConfigKey._GENERATOR_L2S_PATH, $"{ConfigurationFile.MyDocuments}\\dc");
        ...
        public void ExportDataSetXml()
        {
            ...
            string path = cmd.OutputPath(ConfigKey._GENERATOR_DS_PATH, $"{ConfigurationFile.MyDocuments}\\ds");
