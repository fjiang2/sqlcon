...
namespace sqlcon
{
    public static partial class ConfigDefaultValue
    {
        ...
        //directory
        public readonly static string __DIRECTORY = $"{ConfigurationEnvironment.MyDocuments}";
        ...
        //xmldb
        public readonly static string __XMLDB = $"{ConfigurationEnvironment.MyDocuments}\\db";
        ...
        //generator.dpo.path
        public readonly static string __GENERATOR_DPO_PATH = $"{ConfigurationEnvironment.MyDocuments}\\DataModel\\Dpo";
        ...
        //generator.dc.path
        public readonly static string __GENERATOR_DC_PATH = $"{ConfigurationEnvironment.MyDocuments}\\DataModel\\DataContracts";

        //generator.dc.ns
        public const string __GENERATOR_DC_NS = "Sys.DataModel.DataContracts";

        //generator.l2s.path
        public readonly static string __GENERATOR_L2S_PATH = $"{ConfigurationEnvironment.MyDocuments}\\DataModel\\L2s";

        //generator.l2s.ns
        public const string __GENERATOR_L2S_NS = "Sys.DataModel.L2s";

        //generator.de.path
        public readonly static string __GENERATOR_DE_PATH = $"{ConfigurationEnvironment.MyDocuments}\\DataModel\\DataEnum";

        //generator.de.ns
        public const string __GENERATOR_DE_NS = "Sys.DataModel.DataEnum";

        //generator.ds.path
        public readonly static string __GENERATOR_DS_PATH = $"{ConfigurationEnvironment.MyDocuments}\\ds";

        //generator.csv.path
        public readonly static string __GENERATOR_CSV_PATH = $"{ConfigurationEnvironment.MyDocuments}\\csv";
