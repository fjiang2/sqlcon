		...
		public string FullName
		{
			get
			{
				...
				if (this.baseName.Name != "")
				{
					...
					else if (baseName.Provider.DpType != DbProviderType.SqlCe && baseName.Provider.DpType != DbProviderType.Sqlite) //Visual Studio 2010 Windows Form Design Mode, does not support format [database]..[table]
					{
						return $"[{baseName.Name}].{_schema}.[{tableName}]";
					}
					else
